...
RSpec.describe "V1::AuthRequests", type: :request do
  ...
  describe "POST /v1/auth" do
    ...
    context 'when user with that email already exists' do
      before do
        post user_registration_path, params: {email: @user.email, password: "123456", name: "Other User"}
      end
    ...
    context 'when the email is available' do
      before do
        post user_registration_path, params: {email: "newemail@user.com", password: "123456", name: "Other User"}
      end
